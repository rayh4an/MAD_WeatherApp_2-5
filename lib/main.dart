...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  // Simulated weather data for different cities (Commit 3)
  ...
  // Fetch simulated weather data (Commit 4)
  void fetchWeather() {
    ...
    if (enteredCity.isNotEmpty) {
      setState(() {
        ...
        if (_weatherData.containsKey(enteredCity)) {
          ...
          temperatureFahrenheit = "Unknown";
          weatherCondition = "No data available";
        }
